...
public class Slider {
	...
	private double slidePercent = 0.5;
	private double sliderWidth = 10;
	private Type type;
	...
	public Slider(double x, double y, double width, double height, Program program) {
	...
	public Slider(double x, double y, double width, double height, Type type, Program program) {
		this.program = program;
	...
	public void tick(double mouseX) {
	...
	public void sliderToMouse(double mouseX) {

		double sliderX = Math.min(Math.max(mouseX,(x-width/2)),(x+width/2));
	...
	public void draw(Graphics g) {
		...
		double sliderX = Math.min(Math.max(((x-width/2)+(slidePercent*width)-(sliderWidth/2)),(x-width/2)),(x+width/2-sliderWidth));
