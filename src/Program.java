...
public class Program extends JPanel {
	...
	static final double initialCanvasX = WIDTH/2;
	static final double initialCanvasY = HEIGHT/2;
	static final double initialCanvasWidth = WIDTH-200;
	static final double initialCanvasHeight = HEIGHT-200;
	...
	private class MouseWheel implements MouseWheelListener{
		...
		public void mouseWheelMoved(MouseWheelEvent e) {
			...
			case program:
				...
				double wheelMult = 0.1;
				double moveDivide = 1/wheelMult;
	...
	private class MouseMotion implements MouseMotionListener{
		...
		public void mouseDragged(MouseEvent e) {
			...
			if (draggedLayerButton != null) {
				...
				double check = Program.HEIGHT-35+55/2;
